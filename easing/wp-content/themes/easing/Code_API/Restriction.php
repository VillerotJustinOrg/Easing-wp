...
function Router_Restriction($post, $post_id, $label, $token_access): void {
    error_log("");
    error_log("===================================================");
    error_log("              Router Restriction");
    error_log("===================================================");
    error_log("");
    ...
    $node_ID = get_Restriction_id($Restriction_ID, $token_access);
...
function get_Restriction($Restriction_ID, $token_access){
    error_log("");
    error_log("====================================");
