...
function Router_Service_Type_Propriete($post, $post_id, $label, $token_access): void {
    error_log("");
    error_log("===================================================");
    error_log("              Router Service_Type_Propriete");
    error_log("===================================================");
    error_log("");

    $Post_Status = $post->post_status;

    $Service_Type_Propriete_ID = $post->post_title;
    $node_ID = get_Service_Type_Propriete_id($Service_Type_Propriete_ID, $token_access);

    error_log("===================================");
    error_log("              Info");
    error_log("Post Status: ".$Post_Status);
    error_log("Label: ".$label);
    error_log("Service_Type_Propriete_ID: ".$Service_Type_Propriete_ID);
...
function get_Service_Type_Propriete($Service_Type_Propriete_ID, $token_access){
    error_log("");
    error_log("====================================");
    error_log("         Get Service_Type_Propriete");
    error_log("====================================");
    error_log("ID: ".$Service_Type_Propriete_ID);
...
//    error_log(print_r($response, true));
    ...
    $Service_Type_Proprietes = json_decode($response['body'], true);


    if (count($Service_Type_Proprietes['nodes']) > 0) {
        error_log("========================================= Get Service_Type_Propriete");
        error_log("");
        error_log("");

        return $Service_Type_Proprietes['nodes'][0];
    } else {
        error_log("========================================= Get Service_Type_Propriete");
        error_log("");
        error_log("");
...
function get_Service_Type_Propriete_id($Service_Type_Propriete_ID, $token_access){
    error_log("");
    error_log("=========================================");
    error_log("              Get Service_Type_Propriete ID");
    error_log("=========================================");
    error_log("ID: ".$Service_Type_Propriete_ID);
    error_log("token: ".$token_access);

    $Service_Type_Propriete = get_Service_Type_Propriete($Service_Type_Propriete_ID, $token_access);

    if ($Service_Type_Propriete != -1) {
        $node_ID = $Service_Type_Propriete['node_id'];
...
function create_Service_Type_Propriete($post, $post_id, $label, $token_access, $fields):void {
    error_log("");
    error_log("=========================================");
    error_log("              Create Service_Type_Propriete");
    error_log("=========================================");
    error_log("post_id: ".$post_id);
    error_log("label: ".$label);
    error_log("token: ".$token_access);
    error_log("Service_Type_Propriete_ID: ".$post->post_title);
    $Service_Type_Propriete_ID = $post->post_title;
...
function update_Service_Type_Propriete($node_ID, $post_id, $token_access):void {
    error_log("");
    error_log("=====================================");
    error_log("            Edit Service_Type_Propriete");
    error_log("=====================================");
...
function delete_Service_Type_Propriete($node_id, $token_access):void {
    error_log("");
    error_log("=========================================");
    error_log("              Delete Service_Type_Propriete");
    error_log("=========================================");
